...
{
    public class Vepara3DPaymentRequest
    {
        ...
        public Vepara3DPaymentRequest(Settings settings, PosData posData)
        {
        ...
        public string GenerateFormHtmlToRedirect(string FormUrl)
        {
            ...
            formData.AppendFormat("<input type='hidden' name='app_id' value='{0}'>", this._settings.AppKey);
